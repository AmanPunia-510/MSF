...
const NavBar = () => {
    ...
    return (
        <div className='container bg-black py-4 flex items-center justify-between'>
            ...
            <div className='flex flex-col gap-2 items-center w-9 relative z-30 lg:hidden' onClick={handleClick}>
                <span className='w-full pt-px bg-white'></span>
                <span className='w-full pt-px bg-white'></span>
                <span className='w-full pt-px bg-white'></span>
            </div>
            <ul className={`flex items-center gap-6 max-lg:fixed max-lg:top-0 max-lg:bg-black max-lg:min-h-screen max-lg:w-full max-lg:flex-col max-lg:justify-center transition-all ${navState ? "left-0" : "-left-[100%]"}`}>
